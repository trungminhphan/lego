...
$nguoichoi_list = $nguoichoi->get_all_list();$fs = new GridFS();
?>
    ...
    <div class="col-md-12">
        <div class="panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-list"></i> Duyệt điểm cho <?php echo $arr_loaidiem[1]; ?></h4>
            </div>
            <div class="panel-body">
                ...
                <i class="fa fa-heart"></i> Tổng điểm: 1.000 điểm
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Thông tin điểm dành cho người chơi: <b><?php echo $arr_loaidiem[1]; ?></b></h4>
            </div>
