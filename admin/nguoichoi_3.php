	            ...
	            <table id="data-table" class="table table-striped table-bordered table-hovered">
                    ...
                    if($nguoichoi_list){
                        ...
                        foreach($nguoichoi_list as $nc){
                            ...
                            echo '<td class="text-center"><a href="get.nguoichoi_3.html?id='.$nc['_id'].'&act=check#modal-kiemduyet" class="kiemduyet" data-toggle="modal" id="tinhtrang_'.$nc['_id'].'">'.$arr_tinhtrang[$tt].'</a></td>';
...
<form action="post.nguoichoi_3.html" method="POST" class="form-horizontal" data-parsley-validate="true" id="nguoichoiform" enctype="multipart/form-data">
