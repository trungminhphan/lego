    ...
    <div class="col-md-12">
        <div class="panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-list"></i> Danh mục Video</h4>
            </div>
            <div class="panel-body">
                <a href="#modal-dmvideo" data-toggle="modal" class="btn btn-primary m-10 themdmvideo"><i class="fa fa-plus"></i> Thêm mới</a>
...
<div class="modal fade" id="modal-dmvideo">
<form action="post.danhmucvideo.html" method="POST" class="form-horizontal" data-parsley-validate="true" name="congtyform">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title">Danh mục Video</h4>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label class="col-md-3 control-label">Tên danh mục video</label>
                    <div class="col-md-9">
