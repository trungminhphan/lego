...
$danhmucsanpham_list = $danhmucsanpham->get_all_list();
?>
    ...
    <div class="col-md-12">
        <div class="panel panel-danger">
            ...
            <div class="panel-body">
                <a href="#modal-dmsanpham" data-toggle="modal" class="btn btn-primary m-10 themdmsanpham"><i class="fa fa-plus"></i> Thêm mới</a>
...
<div class="modal fade" id="modal-dmsanpham">
<form action="post.danhmucsanpham.html" method="POST" class="form-horizontal" data-parsley-validate="true" name="congtyform">
...
<script>
    $(document).ready(function() {
        $("#themdmsanpham").click(function(){
            $("#id").val();$("#act").val();
        });
        
        $(".suadmsanpham").click(function(){
