    ...
    <div class="col-md-12">
        <div class="panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-list"></i> Duyệt điểm cho <?php echo $arr_loaidiem[2]; ?></h4>
            </div>
	            ...
	            <table id="data-table" class="table table-striped table-bordered table-hovered">
                    ...
                    if($nguoichoi_list){
                        ...
                        foreach($nguoichoi_list as $nc){
                            ...
                            echo '<td class="text-center"><a href="get.nguoichoi_2.html?id='.$nc['_id'].'&act=check#modal-kiemduyet" class="kiemduyet" data-toggle="modal" id="tinhtrang_'.$nc['_id'].'">'.$arr_tinhtrang[$tt].'</a></td>';
...
<form action="post.nguoichoi_2.html" method="POST" class="form-horizontal" data-parsley-validate="true" id="nguoichoiform" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Thông tin điểm dành cho người chơi: <b><?php echo $arr_loaidiem[2]; ?></b></h4>
            </div>
            <div class="modal-body">
	            ...
	            <div class="form-group">
	                <label class="col-md-3 control-label">Cấp độ</label>
	                <div class="col-md-3">
	                    <input type="number" name="capdo" id="capdo" value="" class="form-control" data-parsley-required="true"/>
	                </div>
