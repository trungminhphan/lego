                    ...
                    if($nguoichoi_list){
                        ...
                        foreach($nguoichoi_list as $nc){
                           ...
                           // echo '<td class="text-center">'. ($nc['hinhanh'] ? '<a href="image.html?id='.$nc['hinhanh'].'" data-lightbox="gallery-group-1"><img src="image.html?id='.$nc['hinhanh'].'" height="30" /></a>' : '').'</td>';
                            ...
                            echo '<td class="text-center" width="300"><a href="get.nguoichoi_5.html?id='.$nc['_id'].'&act=check#modal-kiemduyet" class="kiemduyet" data-toggle="modal">'.$arr_tinhtrang[$tt].'</a></td>';
...
<form action="post.nguoichoi_5.html" method="POST" class="form-horizontal" data-parsley-validate="true" name="nguoichoiform" enctype="multipart/form-data">
