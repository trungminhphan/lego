...
$nguoichoi = new NguoiChoi_4();$gridfs = new GridFS();
...
if($act == 'check'){
    ...
    $nguoichoi->diem = $diem;
    if($nguoichoi->check()) transfers_to('nguoichoi_4.html?msg=Cập nhật tình trạng thành công');
} else {
	if($hinhanh_file) $hinhanh = $gridfs->insert_files();      
    ...
    $nguoichoi->diem = $diem;
	$nguoichoi->maso = $maso;
	if($nguoichoi->insert()) transfers_to('nguoichoi_4.html?msg=Thêm thành công');
}
?>