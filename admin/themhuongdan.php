...
if($id && $act=='del'){
    $huongdan->id = $id; $t = $huongdan->get_one();
    if($t['hinhanh']){
    ...
    if($huongdan->delete()) transfers_to('huongdan.html?msg=Xóa thành công!');
}
...
if(isset($_POST['submit'])){
    ...
    $huongdan->tieude = $tieude;
    $huongdan->mota = $mota;
    $huongdan->noidung = $noidung;
    $huongdan->hinhanh = $arr_hinhanh;
    $huongdan->hienthi = $hienthi;
    $huongdan->orders = $orders;
    if($act == 'edit'){
        $huongdan->id = $id;
        if($huongdan->edit()) transfers_to('huongdan.html?msg=Chỉnh sửa thành công');
    } else {
        if($huongdan->insert()) transfers_to('huongdan.html?msg=Thêm thành công');
    }
}
?>
	...
	<div class="col-md-12">
		<div class="panel panel-danger">
            <div class="panel-heading">
                ...
                <h4 class="panel-title"><i class="fa fa-gears"></i> Nhập thông tin hướng dẫn</h4>
            </div>
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <input class="form-control" type="text" id="tieude" name="tieude" placeholder="Tên danh mục hướng dẫn" data-parsley-required="true" value="<?php echo isset($tieude) ? $tieude : ''; ?>" />
                    </div>
                </div>
                <div class="form-group">
            ...
            <div class="panel-footer">
                <a href="huongdan.html" class="btn btn-white"><i class="fa fa-reply-all"></i> Trở về</a>
