...
<head>
	<meta charset="utf-8" />
	<title>THÔNG TIN ĐƠN HÀNG TẠI hiepsinexo.com</title>
	...
	<style type="text/css">
        ...
        h5 {font-size: 24px;}
        h6 {font-size: 20px;}
        body, table.body, p, td {font-size: 18px;line-height:19px;}
    ...
    <tr>
        <td class="center" align="center" valign="top">
            <center>
                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            <table class="six columns">
                                                <tr>
                                                    <td>
                                                        <a href="http://hiepsinexo.com"><img src="http://hiepsinexo.com/images/logo.png" /></a>
                                                    </td>
                ...
                <table class="container content" style="background:#000833;color:#ffffff !important; width: 800px;font-size:15px;">
                    <tr>
                        <td>
                            <h2 style="margin: 10px;text-align:center;">THÔNG TIN ĐƠN HÀNG.</h2>
                            ...
                            <table class="container" style="width:800px;font-size:15px;color:#fff;" cellpadding="10">
                                ...
                                foreach($dh['sanpham'] as $item) {
                                  ...
                                  echo '<tr>
                                    ...
                                    <td style="text-align:right;">'.format_number($item['dongia']).' VNĐ</td>
                                    <td style="text-align:right;">'.format_number($item['thanhtien']).' VNĐ</td>
                                  </tr>';
                                }
                                ?>
                                </tbody>
                                    ...
                                    <tr>
                                        <td class="wrapper">
                                            <table class="four columns">
                                                <tr>
                                                    <td width="300" style="color:#000000;">
                                                        http://hiepsinexo.com
                                                    </td>
                                                    <td class="expander"></td>
                                                </tr>
